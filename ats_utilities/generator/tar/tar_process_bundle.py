    ...
    def validate(self) -> None:
        '''
            ...
            :exceptions:
                ...
                | ATSTypeError: Values must be a mapping.
        '''
        context: str = r'tar_process_bundle::validate(...)'
        ...
        not_none(self.source_dir, context, r'source_dir must be provided.')
        not_none(self.path_replacements, context, r'path_replacements must be provided.')
        not_none(self.exclude_patterns, context, r'exclude_patterns must be provided.')
        ...
        istype(self.source_dir, str, context, r'source_dir must be a string.')
        istype(self.path_replacements, Mapping, context, r'path_replacements must be a mapping.')
        istype(self.exclude_patterns, Sequence, context, r'exclude_patterns must be a sequence.')
