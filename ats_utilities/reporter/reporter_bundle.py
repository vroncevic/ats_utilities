...
class ReporterBundle:
    ...
    def validate(self) -> None:
        ...
        not_none(self.theme, r'theme must be provided')
        not_none(self.logger, r'logger must be provided')
        istype(self.checker, IChecker, r'checker must be an IChecker instance')
        istype(self.theme, IConsoleTheme, r'theme must be an IConsoleTheme instance')
        istype(self.logger, ILogger, r'logger must be an ILogger instance')
