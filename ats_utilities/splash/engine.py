...
from ats_utilities.splash.component_bundle import ATSSplashComponentBundle
...
class Splash(ISplash):
    ...
    def __init__(
        ...
        validate_component(property_splash, SplashProperty, 'SplashProperty')
        ...
        if property_splash.validates():
            ...
            validate_component(terminal_property, TerminalProperties, 'TerminalProperties')
            ...
            if bool(prop['ats_use_github_infrastructure']):
                ...
                validate_component(github, GitHubInfrastructure, 'GitHubInfrastructure')
                ...
                validate_component(ext, ExtInfrastructure, 'ExtInfrastructure')
