...
class OptionBundle:
    ...
    def validate(self) -> None:
        ...
        not_none(self.strategy, r'strategy must be provided')
        not_none(self.context_bundle, r'context bundle must be provided')
        istype(self.parameters, Mapping[str, str], r'parameters must be a Mapping[str, str] instance')
        istype(self.strategy, IParserStrategy, r'strategy must be an IParserStrategy instance')
