...
Info
    Defines interface IJSONLoader with attribute(s) and method(s).
...
class IJSONLoader(ABC):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the string representation of JSON loader (abstract).
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the string representation of JSON loader component.

            :return: The JSON loader component as string representation
            :rtype: <str>
            :exceptions: NotImplementedError
        '''
