...
Info
    Defines abstract class IJSONLoader with method(s).
...
class IJSONLoader(ABC):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the JSON loader component as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the JSON loader component as string representation.
