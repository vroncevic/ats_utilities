...
Info
    ...
    Creates API for writing a configuration/information to a json file.
'''
...
class Object2Json(ATSChecker):
    '''
        Defines class Object2Json with attribute(s) and method(s).
        Creates API for writing a configuration/information to a json file.
        Conversion JSON to configuration content.
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initial Object2Json constructor.
    ...
    def __init__(
        ...
        '''
            Initial Object2Json constructor.
