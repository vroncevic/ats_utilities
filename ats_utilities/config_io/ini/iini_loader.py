...
Info
    Defines abstract class IINILoader with method(s).
...
class IINILoader(ABC):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the INI loader component as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the INI loader component as string representation.
