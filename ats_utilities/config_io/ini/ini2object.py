...
'''
 ...
 Info
     ...
     Created API for reading configuration/information from an ini file.
'''
...
class Ini2Object(BaseReadConfig):
    ...
    def __init__(self, configuration_file, verbose=False):
        ...
        verbose_message(Ini2Object.VERBOSE, verbose, configuration_file)
    ...
    def read_configuration(self, verbose=False):
        ...
        verbose_message(
            Ini2Object.VERBOSE, self.__verbose or verbose, content
        )
        return content
