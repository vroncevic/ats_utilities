...
Info
    Defines abstract class ICFGStorer with method(s).
...
class ICFGStorer(ABC):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the CFG storer component as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the CFG storer component as string representation.
