...
Info
    Defines interface ICFGStorer with attribute(s) and method(s).
...
class ICFGStorer(ABC):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the string representation of CFG storer (abstract).
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the string representation of CFG storer component.

            :return: The CFG storer component as string representation
            :rtype: <str>
            :exceptions: NotImplementedError
        '''
