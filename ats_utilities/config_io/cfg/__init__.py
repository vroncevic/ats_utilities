...
class CfgBase(ATSChecker):
    ...
    def __init__(self, info_file: str | None, verbose: bool = False) -> None:
        ...
        self.cfg2obj: Cfg2Object | None = Cfg2Object(info_file, self._verbose)
        self.obj2cfg: Object2Cfg | None = Object2Cfg(info_file, self._verbose)
        if all([bool(self.cfg2obj), bool(self.obj2cfg)]):
