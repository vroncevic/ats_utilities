...
Info
    Defines abstract class IXMLStorer with method(s).
...
class IXMLStorer(ABC):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the XML storer component as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the XML storer component as string representation.
