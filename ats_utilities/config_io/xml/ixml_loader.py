...
Info
    Defines abstract class IXMLLoader with method(s).
...
class IXMLLoader(ABC):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the XML loader component as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the XML loader component as string representation.
