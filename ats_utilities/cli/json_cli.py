...
'''
 ...
 Info
     Defined class JsonCLI with attribute(s) and method(s).
...
class JsonCLI(JsonBase):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Dunder method for JsonCLI.
    '''

    __slots__ = (
        'VERBOSE', 'tool_operational', 'json2obj', 'obj2json', 'option_parser'
    )
    VERBOSE = 'ATS_UTILITIES::CLI::JSON_CLI'
    ...
    def __init__(self, informations_file, verbose=False):
        ...
        verbose_message(JsonCLI.VERBOSE, verbose, 'init ATS cli')
        JsonBase.__init__(self, informations_file, verbose=verbose)
    ...
    def __str__(self):
        ...
        '''
        return '{0} ({1})'.format(
            self.__class__.__name__, JsonBase.__str__(self)
        )
