...
Info
    Defines the abstract class IInfoExpose with method(s).
    Provides an interface for exposing helper methods to extract configuration properties.
'''
