...
class ITemplateDir(ABC):
    '''
        ...
        It defines:
            ...
            :attributes: None.
            :methods:
                | template_dir - Property methods for set/get operations (abstract).
                | not_none - Checks template dir is not None (abstract).
                | __str__ - Returns the string representation of ATS project directory (abstract).
    '''
