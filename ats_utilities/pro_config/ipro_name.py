...
class IProName(ABC):
    '''
        ...
        It defines:
            ...
            :attributes: None.
            :methods:
                | pro_name - Property methods for set/get operations (abstract).
                | not_none - Checks project name is not None (abstract).
                | __str__ - Returns the string representation of ATS project name (abstract).
    '''
