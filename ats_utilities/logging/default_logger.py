...
Info
    Defines class DefaultLogger with attribute(s) and method(s).
...
from .ilogger import IATSLogger, LogFormats
...
class DefaultLogLevels(int, Enum):
    '''
        Defines class DefaultLogLevels with attribute(s) and method(s).
...
class DefaultLogger(IATSLogger):
    '''
        Defines class DefaultLogger with attribute(s) and method(s).
        Creates an API for the ATS logging mechanism.
        ...
        It defines:
            ...
            :attributes:
                ...
                | 
            :methods:
                | __init__ - Initials DefaultLogger constructor.
                | write_log - Writes message to log file.
    '''

    LOG_FORMATS: ClassVar[type[LogFormats]] = LogFormats
    LOG_LEVELS: ClassVar[type[DefaultLogLevels]] = DefaultLogLevels
    ...
    def __init__(
        ...
        '''
            Initials DefaultLogger constructor.
