...
Info
    Defines class DefaultCheckReporter with attribute(s) and method(s).
    Creates an API for checking parameters for methods and functions.
'''

from typing import List
from ats_utilities.checker.icheck_reporter import ICheckReporter, ParamMetadata
...
class DefaultCheckReporter(ICheckReporter):
    '''
        Defines class DefaultCheckReporter with attribute(s) and method(s).
