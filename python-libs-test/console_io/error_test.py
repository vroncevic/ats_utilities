...
"""
 ...
 Info
     Define class TestATSError with attribute(s) and method(s).
     Test TestATSError attributes.
"""
    ...
    """
        ...
        It defines:
            ...
            method:
                ...
                test_error_message_bad_call - Test bad call
                test_error_message_type_error - Test error message
    """
