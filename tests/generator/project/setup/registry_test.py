...
Info
    Unit tests for ProjectRegistry class.
'''
...
class ProjectRegistryTest(unittest.TestCase):
    '''
        Defines class ProjectRegistryTest with attribute(s) and method(s).
        Tests ProjectRegistry logic.
    '''

    def test_create_bundle(self) -> None:
        """Tests create_bundle on ProjectRegistry."""
        setup = {
        ...
        bundle = ProjectRegistry.create_bundle(
            ProjectDependencies(
                context_bundle=context_bundle,
