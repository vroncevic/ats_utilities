...
class CheckerFactoryTest(unittest.TestCase):
    '''
        Defines class CheckerFactoryTest with attribute(s) and method(s).
        Tests CheckerFactory static factory logic.
    '''

    def test_create_default_checker_bundle(self) -> None:
        bundle = CheckerFactory.create_default_checker_bundle()
