...
class TestInfoSchema(unittest.TestCase):
    ...
    def test_is_registered_config_key(self):
        ...
        self.assertTrue(InfoSchema.is_registered_config_key(InfoKeys.ATS_NAME))
    ...
    def test_get_config_keys_to_dependency_keys(self):
        ...
        self.assertEqual(mapping[InfoKeys.ATS_NAME], InfoKeys.DEPENDENCY_NAME)
    ...
    def test_optional_and_required_keys(self):
        ...
        self.assertIn(InfoKeys.ATS_LOGO_PATH, optional_keys)
        self.assertIn(InfoKeys.ATS_NAME, required_keys)
        self.assertTrue(InfoSchema.is_optional_config_key(InfoKeys.ATS_LOGO_PATH))
        self.assertTrue(InfoSchema.is_required_config_key(InfoKeys.ATS_NAME))

    def test_get_name_of_config_key_valid(self):
        """Test retrieving dependency name for a registered config key."""
        dep_name = InfoSchema.get_name_of_config_key(InfoKeys.ATS_VERSION)
        self.assertEqual(dep_name, InfoKeys.DEPENDENCY_VERSION)
    ...
    def test_get_config_key_to_type(self):
        ...
        self.assertIn(InfoKeys.ATS_NAME, type_mapping)
