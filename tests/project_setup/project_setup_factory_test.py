...
Info
    Unit tests for ProjectSetupFactory class.
'''
...
class ProjectSetupFactoryTest(unittest.TestCase):
    '''
        Defines class ProjectSetupFactoryTest with attribute(s) and method(s).
        Tests ProjectSetupFactory static factory logic.
    '''
    ...
    def test_create_default_project_setup_bundle(self) -> None:
        ...
        bundle = ProjectSetupFactory.create_default_project_setup_bundle(
            setup=setup,
