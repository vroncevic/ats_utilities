...
from ats_utilities.config_io.processor.iini_processor import IINIProcessor as BaseIINIProcessor
...
class Object2IniTestCase(TestCase):
    '''
        ...
        It defines:
            ...
            :attributes:
                | obj2ini - API for checking base Object2File.
                | ini2obj - API for checking base File2Object.
            :methods:
    ...
    def setUp(self) -> None:
        ...
        self.ini2obj: File2Object = File2Object('ini', 
            f'{dirname(dirname(dirname(__file__)))}/assets/config/ats_cli_ini_api.ini'
        )
        self.obj2ini: Object2File = Object2File('ini', 
            f'{dirname(dirname(dirname(__file__)))}/assets/config/ats_cli_ini_api.ini'
        )
