...
class YAMLStorerTestCase(TestCase):
    ...
    def test_store_configuration_success(self) -> None:
        ...
        storer = ConfigStorer('yaml', 
            info_file='dummy.yaml',
            object2file=mock_obj2yaml,
    ...
    @mock.patch('ats_utilities.config_io.storer.config_storer.dump')
