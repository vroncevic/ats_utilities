...
class Yaml2ObjectTestCase(TestCase):
    '''
        ...
        It defines:
            ...
            :attributes:
                | yaml2obj - API for checking base File2Object.
            :methods:
    ...
    def setUp(self) -> None:
        ...
        self.yaml2obj: File2Object = File2Object('yaml', 
    ...
    @mock.patch('ats_utilities.config_io.loader.file2object.ConfFile')
    ...
    def test_none_config_path(self) -> None:
        ...
        yaml2obj = File2Object('yaml', None)
