...
from ats_utilities.config_io.processor.iyaml_processor import IYAMLProcessor as BaseIYAMLProcessor
...
class Object2YamlTestCase(TestCase):
    ...
    def test_not_none(self) -> None:
        ...
        obj2yaml: Object2File = Object2File('yaml', 
