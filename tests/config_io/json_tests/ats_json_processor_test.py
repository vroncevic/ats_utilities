...
Info
    Creates test cases for checking JSONProcessor.
Execute
    python3 -m unittest -v tests/config_io/json/ats_json_processor_test.py
'''
...
class JSONProcessorTestCase(TestCase):
