...
class ATSBaseJson(ConfigLoader):
    '''Simple Class for checking ConfigLoader.'''

    _CONFIG: str = '/assets/config/correct/ats_cli_json_api.json'
...
class JsonBaseUnitTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.mock_json2obj = MagicMock(spec=File2Object)
        ...
        self.json_loader: ConfigLoader = ConfigLoader(
            info_file=self.config_path,
            config2object=self.mock_json2obj,
    ...
    def test_load_configuration_empty(self) -> None:
        ...
        mock_json2obj_empty = MagicMock(spec=File2Object)
        mock_json2obj_empty.read_configuration.return_value = None
        loader = ConfigLoader(
            info_file=self.config_path,
            config2object=mock_json2obj_empty
        )
        self.assertEqual(loader.load_configuration(), {})

    def test_init_bool_false(self) -> None:
        '''Test initialization when json2obj is falsy in bool evaluation.'''
        ...
        mock_json2obj = FalsyJson2Object()
        mock_json2obj.read_configuration = MagicMock(return_value=None)
        loader = ConfigLoader(
            info_file=self.config_path,
            config2object=mock_json2obj
        )
        self.assertEqual(loader.load_configuration(), {})
        mock_json2obj.read_configuration.assert_not_called()
