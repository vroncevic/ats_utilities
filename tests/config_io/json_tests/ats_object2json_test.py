...
from ats_utilities.config_io.processor.ijson_processor import IJSONProcessor as BaseIJSONProcessor
...
class Object2JsonTestCase(TestCase):
    '''
        ...
        It defines:
            ...
            :attributes:
                | obj2json - API for checking base Object2File.
                | json2obj - API for checking base File2Object.
            :methods:
    ...
    def setUp(self) -> None:
        ...
        self.json2obj: File2Object = File2Object('json', 
            f'{dirname(dirname(dirname(__file__)))}/assets/config/ats_cli_json_api.json'
        )
        self.obj2json: Object2File = Object2File('json', 
            f'{dirname(dirname(dirname(__file__)))}/assets/config/ats_cli_json_api.json'
        )
