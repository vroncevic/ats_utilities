...
class XmlBaseUnitTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.mock_xml2obj = MagicMock(spec=File2Object)
        ...
        self.xml_loader: ConfigLoader = ConfigLoader(
            info_file=self.config_path,
            config2object=self.mock_xml2obj,
    ...
    def test_load_configuration_empty(self) -> None:
        ...
        mock_xml2obj_empty = MagicMock(spec=File2Object)
        mock_xml2obj_empty.read_configuration.return_value = None
        loader = ConfigLoader(
            info_file=self.config_path,
            config2object=mock_xml2obj_empty
        )
        self.assertEqual(loader.load_configuration(), {})
