...
from ats_utilities.config_io.processor.icfg_processor import ICFGProcessor as BaseICFGProcessor
...
class Object2CfgTestCase(TestCase):
    '''
        ...
        It defines:
            ...
            :attributes:
                | obj2cfg - API for checking base Object2File.
            :methods:
    ...
    def setUp(self) -> None:
        ...
        self.obj2cfg: Object2File = Object2File('cfg', 
