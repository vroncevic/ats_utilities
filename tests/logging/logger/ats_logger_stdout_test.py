...
Info
    ...
    Creates test cases for checking stdout logging functionalities of Logger.
Execute
    python3 -m unittest -v tests/logging/logger/ats_logger_stdout_test.py
'''
