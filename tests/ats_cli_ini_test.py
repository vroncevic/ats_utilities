...
Info
    Defines classes IniTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of CLI.
Execute
    python3 -m unittest -v ats_cli_ini_test
'''
...
class IniTestCase(TestCase):
    '''
        Defines class IniTestCase with attribute(s) and method(s).
        ...
        It defines:
            ...
            :methods:
                ...
                | test_not_none - Test is ATSCliIniAPI not None.
    ...
    def setUp(self) -> None:
        ...
        self.ats_cli_ini_api.option_parser.add_operation = self.mock_add_new
        self.ats_cli_ini_api.option_parser.parse_args = self.mock_pars_arg
    ...
    def test_not_none(self) -> None:
        '''Test for create'''
        self.assertIsNotNone(self.ats_cli_ini_api)
