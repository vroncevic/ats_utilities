...
Info
    ...
    Creates test cases for checking functionalities of Splasher.
Execute
    python3 -m unittest -v tests/splasher/ats_splasher_engine_test.py
'''
...
class ATSSplashTestCase(TestCase):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | test_splash_disabled - Test disabled splasher.
    '''
        ...
        try:
            bundle: SplashComponentBundle | None = SplashComponentBundle(
                prop={
                    ...
                    SplashKeys.ATS_LOGO_PATH: f'{dirname(dirname(__file__))}/assets/config/app.logo',
    ...
    def test_str(self, mock_sleep, mock_print, mock_stdout) -> None:
        '''Test string representation of Splasher.'''
        bundle = SplashComponentBundle(
            prop={
                SplashKeys.ATS_ORGANIZATION: 'App Example',
                SplashKeys.ATS_REPOSITORY: 'app_example',
