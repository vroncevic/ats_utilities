...
try:
    from ats_utilities.text.stdout_text import ATS, ATS_PROCESS, CON, DBG, RST
...
class verbose(object):
    """
    Define class verbose with attribute(s) and method(s).
    Define verbose decorator for print console mechanism.
    It defines:
        attribute:
    ...
    def __call__(self, *args, **kwargs):
        ...
        msg_debug = "{0}{1}{2}".format(DBG, msg_merged, RST)
