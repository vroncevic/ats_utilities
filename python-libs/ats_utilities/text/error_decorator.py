...
try:
    from ats_utilities.text.stdout_text import ATS, ATS_PROCESS, CON, ERR, RST
...
class error(object):
    """
    Define class error with attribute(s) and method(s).
    Define error decorator for print console mechanism.
    It defines:
        attribute:
    ...
    def __call__(self, *args, **kwargs):
        ...
        msg_debug = "{0}{1}{2}".format(ERR, msg_merged, RST)
